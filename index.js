...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Wizzy\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=558681140024:+55 86 8114-0024\n' //Nomor whatsapp kamu
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD FIG ZAP BOT*',
					...
					userB: `──「 LISTA 」──\nOlá!\nDesculpe, Você não está registrado no banco de dados. Registre-se para fazer amizade com o bot, \n\nCommand : ${prefixbotbot}daftar nome|idade\nExemplo : ${prefixbotbot}daftar Lucas|17\n\n──「 FIG ZAP BOT 」──`,
			...
			const ownerNumber = ["558681140024@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"558681140024@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["558681140024@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["558681140024@s.whatsapp.net"]//ubah nomor lo
			const premium = ["558681140024@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
